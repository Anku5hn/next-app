...
<footer className="bg-indigo-500">
    ...
    <div className="px-4 py-6 bg-indigo-500 md:flex md:items-center md:justify-between">
        <span className="text-sm text-white sm:text-center">© 2023 <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span>
